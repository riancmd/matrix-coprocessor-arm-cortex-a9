...
module add_M(input clk, //sinal de clock
	...
	always@(posedge clk or posedge rst) begin
		if(rst) begin //se houver sinal de reset
			...
			temp_m[44:36] = {1'b0, m1[39:32]} + {1'b0, m2[39:32]}; //primeira soma
			temp_m[34:27] = {1'b0, m1[31:24]} + {1'b0, m2[31:24]}; //segunda soma
			temp_m[25:18] = {1'b0, m1[23:16]} + {1'b0, m2[23:16]}; //terceira soma
			temp_m[16:9]  = {1'b0, m1[15:8]}  + {1'b0, m2[15:8]};  //quarta soma
			temp_m[7:0]   = {1'b0, m1[7:0]}   + {1'b0, m2[7:0]};   //quinta soma
